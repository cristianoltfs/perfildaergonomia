...
"}")
        ...
        self.btnCarta.setGeometry(QtCore.QRect(585, 704, 181, 51))
        self.btnCarta.setMinimumSize(QtCore.QSize(20, 50))
...
"")
        ...
        self.btnAtualizaPontos.setGeometry(QtCore.QRect(586, 537, 141, 41))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(11)
