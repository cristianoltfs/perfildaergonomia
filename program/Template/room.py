...
class Ui_room(object):
    def setupUi(self, room):
        ...
        room.resize(403, 350)
        room.setMinimumSize(QtCore.QSize(403, 350))
        room.setMaximumSize(QtCore.QSize(403, 350))
        icon = QtGui.QIcon()
        ...
        self.label_2.setGeometry(QtCore.QRect(130, 50, 141, 41))
...
"")
        ...
        self.leNickName.setGeometry(QtCore.QRect(118, 130, 254, 36))
        font = QtGui.QFont()
...
"}")
        ...
        self.leRoom = QtWidgets.QLineEdit(self.centralwidget)
        self.leRoom.setGeometry(QtCore.QRect(120, 180, 252, 36))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(11)
        font.setBold(True)
        font.setWeight(75)
        self.leRoom.setFont(font)
        self.leRoom.setStyleSheet("QLineEdit {\n"
"    border: 2px solid rgb(34,63,102);\n"
"    border-radius: 5px;\n"
"    padding: 5px;\n"
"    backgroud-color: rgb(30,30,30);\n"
...
"    color: rgb(50, 50, 50);\n"
"}")
        self.leRoom.setObjectName("leRoom")
        self.label_3 = QtWidgets.QLabel(self.centralwidget)
        self.label_3.setGeometry(QtCore.QRect(23, 130, 89, 36))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
...
"")
        ...
        self.label_5.setGeometry(QtCore.QRect(23, 180, 91, 36))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(14)
        font.setBold(True)
...
"}")
        ...
        self.btnClose.setGeometry(QtCore.QRect(280, 260, 91, 31))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(11)
...
"}")
        ...
        self.groupBox.setGeometry(QtCore.QRect(10, 30, 381, 291))
...
"}")
    ...
    def retranslateUi(self, room):
        ...
        self.label_5.setText(_translate("room", "<html><head/><body><p align=\"center\">Room</p></body></html>"))
